...
### 시각화
![numeric](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN09-2nd-5Team/blob/main/image/numeric_features_distribution.png?raw=true)
![numeric](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN09-2nd-5Team/blob/main/image/feature_correlation_heatmap.png?raw=true)
...
![XGBoost Calibration Curve](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN09-2nd-5Team/blob/main/image/XB_calibration_curve.png?raw=true)

### 2. XGBoost Confusion Matrix
![XGBoost Confusion Matrix](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN09-2nd-5Team/blob/main/image/XG_confusion_matrix.png?raw=true)

### 3. XGBoost ROC Curve
![XGBoost ROC Curve](https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN09-2nd-5Team/blob/main/image/XG_roc_curve.png?raw=true)
